...
public class EnemyAI_Melee_v2 : MonoBehaviour
{
    [Header("General")]
    ...
    public static int enemyMeleeCount = 0;
    ...
    public void ActivateEnemyMeleeCollider()
    {
        meleeWeapon.SetActive(true);
    }

    public void DeactivateEnemyMeleeCollider()
    {
